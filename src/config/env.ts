...
export const PUSH_NOTIFICATION_ICON_URL = process.env.PUSH_NOTIFICATION_ICON_URL;
export const PUSH_NOTIFICATION_BADGE_URL = process.env.PUSH_NOTIFICATION_BADGE_URL;
export const PUSH_NOTIFICATION_TITLE = process.env.PUSH_NOTIFICATION_TITLE || 'New message';
